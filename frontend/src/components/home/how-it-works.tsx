      ...
      >
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-16">
            <button className="bg-gradient-to-r from-indigo-600 to-purple-600 py-3 px-8 rounded-full font-semibold transition transform hover:scale-105 hover:shadow-lg inline-flex items-center">
