...
import flip_img from "@/assets/images/flip.jpg";
            ...
            <div className="md:w-1/2 mb-10 md:mb-0">
              <div className="animate-fade-in">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button className="bg-gradient-to-r from-indigo-600 to-purple-600 py-3 px-8 rounded-full font-semibold transition transform hover:scale-105 hover:shadow-lg flex items-center justify-center">
                    Start Playing <ArrowRight size={18} className="ml-2" />
                  </button>
                  <button className="bg-transparent border border-indigo-500 py-3 px-8 rounded-full font-semibold transition hover:bg-indigo-500/20 flex items-center justify-center">
                    Learn More
                  </button>
                </div>
            ...
            <div className="md:w-1/2 md:pl-10 animate-float">
              <div className="relative">
                ...
                <div className="relative bg-gray-900 rounded-lg p-2">
                  <Image src={flip_img} alt="Hero Image" />
                </div>
